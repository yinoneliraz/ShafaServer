...
/**
 * Created by Yinon on 20/06/2017.
 */
public class UpdateUserToken implements HttpHandler {
    public void handle(HttpExchange he) throws IOException {
        int retVal;
        DateFormat dateFormat = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
        Date date = new Date();
        System.out.println(dateFormat.format(date) + ":Update user token, started handling");
        ...
        os.close();
        System.out.println(dateFormat.format(date) + ":Update user token, finished handling");
    }
}
