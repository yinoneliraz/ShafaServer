...
public class EditItem implements HttpHandler {
    public void handle(HttpExchange he) throws IOException {
        ...
        Date date = new Date();
        System.out.println(dateFormat.format(date) + ":Edit item, started handling");
        ...
        query= Server.Constants.getEditItemQuery(params);
        ...
        os.close();
        System.out.println(dateFormat.format(date) + ":Edit item, finished handling");
    }
}
